...
echo ""
echo " Next steps:"
echo "  1. Download data:  python scripts/download_robomind.py --max-episodes 100 --workers 3"
echo "  2. Convert data:   python scripts/convert_robomind.py --data-dir data/raw/robomind --fps 5 --output data/processed/metadata.json"
